...
local NpcConfig = {
	...
	RangeTable = { 							-- the attacks should be listed in order of least common to most common
		Short = {{"Melee", 60,},{"ChargedSlash",20},{"WudangPalm",20},}, --A range of 1 - 12 studs for this example
		Med = 	{{"WaterCoil",100},}, -- A range of 12 - 30 for this example
		Long = 	{{"GapClose",50,"WaterDragonSeal",50}}, 	-- A range of 30 - 50 for this example
	},
	Combos = {"Melee","WudangPalm","GapClose"}; -- combos that the boss will peridocially perform
	CombatInitialString = {"Enchant","GapClose","Melee"}; -- the thing the boss wants to do the instant the battle starts.
	onCooldown = {
